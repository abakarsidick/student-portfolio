...
# Projects Page with Filtering System
    ...
    projects = {
        ...
        "Dissertation": "AI module for malaria detection"
    }
...
# Testimonials Page
    ...
    st.write("🌟 A Motivator🤝, Hardworking😘, Teamwork and motivator Friend💖 Such an Innovative Software Engineer! – Ali")
...
# Timeline Page
    ...
    timeline_data = [
        ...
        ("Year 3", "📖 Final Year Dissertation: AI Model for Malaria Detection"),
    ]
...
# Contact Page with Validation
    ...
    st.write("[🔗 LinkedIn](https://linkedin.com/in/abakar-2b5a06333)")
...
# Settings Page
    ...
    field_of_study = st.text_input("Field of Study", "Software Engineering, Year 3")
    university = st.text_input("University", "INES Ruhengeri")
    about_me = st.text_area("About Me", "I am Abakar, an enthusiastic software engineering student...")
